...
const TeamMemberFormPopup: React.FC<TeamMemberFormPopupProps> = ({ isOpen, onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md overflow-y-scroll">
        <h2 className="text-2xl font-semibold mb-4 text-black">Create Team Member</h2>
